    ...
    function Node(data) {
        ...
        this.formatNode = function (opts) {
            ...
            if (typeof data.type !== 'undefined') {
                descString = '<p>' + self.data.type + '</p>';
            }
            if (opts.showControls) {
                var buttonsHtml = "<div><div class='org-add-button' style='color:green;font-weight:bold'>" + opts.newNodeText + "</div><div class='org-del-button' style='color:orangered;font-weight:bold'>" + 'Del' + "</div></div>";
            }
            else {
                buttonsHtml = '';
            }
